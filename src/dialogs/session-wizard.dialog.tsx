...
export default function SessionWizardDialog({ dialogOpen, onOpenChange, trigger, workspaceId }: Props) {
    // Store
                    ...
                    {step === 3 && (
                        <div className="space-y-2">
                            ...
                            <p className="text-muted-foreground text-center text-xs py-4 px-2">
                                Shellpipe saves your session details including passwords and private keys securely.
